...
<p>
    <a href="{{ url('/registrar') }}" class="btn btn-success" role="button" aria-pressed="true">Agregar</a>
</p>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $bombero->rol }}</td>
            <td>
                <a href="{{ url('/bomberos/edit/').$bombero->id }}"><i class="btn btn-warning fas fa-edit"></i></a> 
            </td>
            <td>
